...
**Closest incumbent:** https://huangdarren1106.github.io/receiptify (Receiptify — Spotify listening data as a thermal receipt, 1.2M generated as of 2026-04-08).
...
**Tech stack:** Node 20+, TypeScript, **zero runtime dependencies**. Pure string-template SVG. `npx github:KeWang0622/vibereceipt` works without any install.
